...
const MealType = () => {
    ...
    useEffect(() => {
        axios.post("https://backend-zjgv.onrender.com/api/filter", { lcost: formData.lcost, location: formData.location, hcost: formData.hcost, cuisine: formData.cuisine, mealtype: mealName, sort: formData.sort, page: formData.page }).then((res) => setFilteredData(res.data.result))
        axios.post("https://backend-zjgv.onrender.com/api/filter", { lcost: formData.lcost, location: formData.location, hcost: formData.hcost, cuisine: formData.cuisine, mealtype: mealName, sort: formData.sort, page: formData.page }).then((res) => setFilteredFullData(res.data.full))
    }, [formData, mealName])
